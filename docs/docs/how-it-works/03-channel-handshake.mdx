...
it is about to send a channel open init message in [`InstantiateMsg`](../contract-api/cw-ica-controller/01-instantiate-msg.mdx) or
[`ExecuteMsg::CreateChannel`](../contract-api/cw-ica-controller/02-execute-msg.mdx#createchannel).
...
based on the `channel_open_init_options` that are passed to it in [`InstantiateMsg`](../contract-api/cw-ica-controller/01-instantiate-msg.mdx) or [`ExecuteMsg::CreateChannel`](../contract-api/cw-ica-controller/02-execute-msg.mdx#createchannel).
