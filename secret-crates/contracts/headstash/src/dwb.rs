...
pub const DWB_CAPACITY: u16 = 64;
pub const BTBE_CAPACITY: u16 = 64;

use secret_toolkit::storage::Item;

use crate::{
    btbe::{merge_dwb_entry, stored_balance},
    state::{safe_add, safe_add_u64},
...
pub fn amount_u64(amount_spent: Option<u128>) -> StdResult<u64> {
    // include multiplier here
    let amount_spent = (Uint128::from(amount_spent.unwrap_or_default())).u128();
