...
pub mod voice {
    ...
    #[cw_serde]
    // #[cfg_attr(feature = "library", derive(cw_orch::ExecuteFns))] // cw-orch automatic
    pub enum ExecuteMsg {
    ...
    // #[cfg_attr(feature = "library", derive(cw_orch::QueryFns))] // cw-orch automatic
    pub enum QueryMsg {
...
pub mod proxy {
    ...
    pub enum QueryAnswer {
        InstantiatorResponse { instantiator: Addr },
    }
}
