...
pub static BLOOMSBLOOMS: Keymap<String, bloom::IbcBloomMsg> = Keymap::new(b"blomoblom");
...
pub static BLOOM_CONFIG: Item<bloom::BloomConfig> = Item::new(KEY_B_CONFIG);
...
pub mod bloom {
    ...
    pub struct BloomConfig {
        /// min cadance before messages are eligible to be added to mempool (in blocks)
